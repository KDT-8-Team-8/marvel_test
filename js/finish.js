function result(char) {
  ...
  if (char === "dr_strange") {
    imgElement.src = "/marvel_test/imge/hero/dr_strange.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/SpiderMan.jpg";
    bestMatchImgElement.alt = "spider_man";

    worstMatchElement.textContent = "캡틴 아메리카";
    worstMatchImgElement.src = "/marvel_test/imge/hero/CaptainAmerica.jpg";
    worstMatchImgElement.alt = "cpt_america";
  } else if (char === "hulk") {
    imgElement.src = "/marvel_test/imge/hero/Hulk.jpg";
    imgElement.alt = "hulk";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/Thanos.jpg";
    bestMatchImgElement.alt = "thanos";

    worstMatchElement.textContent = "앤트맨";
    worstMatchImgElement.src = "/marvel_test/imge/hero/AntMan.jpg";
    worstMatchImgElement.alt = "ant_man";
  } else if (char === "thanos") {
    imgElement.src = "/marvel_test/imge/hero/Thanos.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/Hulk.jpg";
    bestMatchImgElement.alt = "hulk";

    worstMatchElement.textContent = "캡틴 마블";
    worstMatchImgElement.src = "/marvel_test/imge/hero/CaptainMarvel.jpg";
    worstMatchImgElement.alt = "cpt_marvel";
  } else if (char === "iron_man") {
    imgElement.src = "/marvel_test/imge/hero/IronMan.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/Vision.jpg";
    bestMatchImgElement.alt = "vision";

    worstMatchElement.textContent = "호크아이";
    worstMatchImgElement.src = "/marvel_test/imge/hero/HawkEye.png";
    worstMatchImgElement.alt = "hawk_eye";
  } else if (char === "vision") {
    imgElement.src = "/marvel_test/imge/hero/Vision.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/IronMan.jpg";
    bestMatchImgElement.alt = "iron_man";

    worstMatchElement.textContent = "블랙팬서";
    worstMatchImgElement.src = "/marvel_test/imge/hero/BlackPanther.jpg";
    worstMatchImgElement.alt = "black_panther";
  } else if (char === "witch") {
    imgElement.src = "/marvel_test/imge/hero/ScarletWitch.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/Roki.jpg";
    bestMatchImgElement.alt = "roki";

    worstMatchElement.textContent = "토르";
    worstMatchImgElement.src = "/marvel_test/imge/hero/Thor.jpg";
    worstMatchImgElement.alt = "thor";
  } else if (char === "roki") {
    imgElement.src = "/marvel_test/imge/hero/Roki.jpg";
    imgElement.alt = "roki";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/ScarletWitch.jpg";
    bestMatchImgElement.alt = "witch";

    worstMatchElement.textContent = "블랙위도우";
    worstMatchImgElement.src = "/marvel_test/imge/hero/BlackWidow.jpg";
    worstMatchImgElement.alt = "black_widow";
  } else if (char === "spider_man") {
    imgElement.src = "/marvel_test/imge/hero/SpiderMan.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/dr_strange.jpg";
    bestMatchImgElement.alt = "dr_strange";

    worstMatchElement.textContent = "스타로드";
    worstMatchImgElement.src = "/marvel_test/imge/hero/StarLord.jpg";
    worstMatchImgElement.alt = "star_load";
  } else if (char === "hawk_eye") {
    imgElement.src = "/marvel_test/imge/hero/HawkEye.png";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/Thor.jpg";
    bestMatchImgElement.alt = "thor";

    worstMatchElement.textContent = "아이언맨";
    worstMatchImgElement.src = "/marvel_test/imge/hero/IronMan.jpg";
    worstMatchImgElement.alt = "iron_man";
  } else if (char === "cpt_america") {
    imgElement.src = "/marvel_test/imge/hero/CaptainAmerica.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/StarLord.jpg";
    bestMatchImgElement.alt = "star_load";

    worstMatchElement.textContent = "닥터 스트레인지";
    worstMatchImgElement.src = "/marvel_test/imge/hero/dr_strange.jpg";
    worstMatchImgElement.alt = "dr_strange";
  } else if (char === "cpt_marvel") {
    imgElement.src = "/marvel_test/imge/hero/CaptainMarvel.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/BlackPanther.jpg";
    bestMatchImgElement.alt = "black_panther";

    worstMatchElement.textContent = "타노스";
    worstMatchImgElement.src = "/marvel_test/imge/hero/Thanos.jpg";
    worstMatchImgElement.alt = "thanos";
  } else if (char === "ant_man") {
    imgElement.src = "/marvel_test/imge/hero/AntMan.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/BlackWidow.jpg";
    bestMatchImgElement.alt = "black_widow";

    worstMatchElement.textContent = "헐크";
    worstMatchImgElement.src = "/marvel_test/imge/hero/Hulk.jpg";
    worstMatchImgElement.alt = "hulk";
  } else if (char === "black_widow") {
    imgElement.src = "/marvel_test/imge/hero/BlackWidow.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/AntMan.jpg";
    bestMatchImgElement.alt = "ant_man";

    worstMatchElement.textContent = "로키";
    worstMatchImgElement.src = "/marvel_test/imge/hero/Roki.jpg";
    worstMatchImgElement.alt = "roki";
  } else if (char === "black_panther") {
    imgElement.src = "/marvel_test/imge/hero/BlackPanther.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/CaptainMarvel.jpg";
    bestMatchImgElement.alt = "cpt_marvel";

    worstMatchElement.textContent = "비전";
    worstMatchImgElement.src = "/marvel_test/imge/hero/Vision.jpg";
    worstMatchImgElement.alt = "vision";
  } else if (char === "star_load") {
    imgElement.src = "/marvel_test/imge/hero/StarLord.jpg";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/CaptainAmerica.jpg";
    bestMatchImgElement.alt = "cpt_america";

    worstMatchElement.textContent = "스파이더맨";
    worstMatchImgElement.src = "/marvel_test/imge/hero/SpiderMan.jpg";
    worstMatchImgElement.alt = "spider_man";
  } else if (char === "thor") {
    imgElement.src = "/marvel_test/imge/hero/Thor.jpg";
    imgElement.alt = "thor";
    ...
    bestMatchImgElement.src = "/marvel_test/imge/hero/HawkEye.png";
    bestMatchImgElement.alt = "hawk_eye";

    worstMatchElement.textContent = "스칼렛위치";
    worstMatchImgElement.src = "/marvel_test/imge/hero/ScarletWitch.jpg";
